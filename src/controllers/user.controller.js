...
const loginUser = asyncHandler(async (req, res) => {
  ...
  const loggedInUser = await User.findById(user._id).select(
    "-fullname -password -refreshToken -coverImage"
  );
...
// @desc Get user channel profile by username
// @access Public
// @params username
// @returns {ApiResponse} - Channel profile object with status code 200
// @throws ApiError - 404, 500
// @cookies none
const getUserChannelProfile = asyncHandler(async (req, res) => {
    ...
    throw new ApiError(
      404,
      "No Channel found for the current username parameter"
    );
  }
...
// @access Private
// @returns {ApiResponse} - Watch history array with status code 200
// @throws ApiError - 400, 500
// @cookies none
// @body none
const getWatchHistory = asyncHandler(async (req, res) => {
  ...
  if(!user){
    throw new ApiError(400, "unable to fetch watch history");
  }
